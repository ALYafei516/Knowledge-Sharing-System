...
?>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold text-danger">Post List</h6>
                            	</div>
        			...
        			<span id="form_message"></span>
		          	<div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label>Post Decription <span class="text-danger">*</span></label>
                                <input type="text" name="expert_password" id="expert_password" class="form-control" required  data-parsley-trigger="keyup" />
                            </div>
		          		</div>
		          	</div>
...
<div id="viewModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal_title">View Post Details</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
                ...
                $('#uploaded_image').html('<img src="'+data.expert_profile_image+'" class="img-fluid img-thumbnail" width="150" />')
    ...
    $(document).on('click', '.view_button', function(){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                html += '<tr><td colspan="2" class="text-center"><img src="'+data.expert_profile_image+'" class="img-fluid img-thumbnail" width="150" /></td></tr>';
