...
$object->query = "
    ...
    WHERE expert_id = '".$_SESSION["admin_id"]."'
    ";
                            ...
                            <div class="card-body">
                                <!--<div class="row">
                                    <div class="col-md-6">!-->
                                        ...
                                        <div class="form-group">
                                            <label>expert Image <span class="text-danger">*</span></label>
                                            <br />
...
$(document).ready(function(){
    ...
    $('#uploaded_image').html('<img src="<?php echo $row["expert_profile_image"]; ?>" class="img-thumbnail" width="100" /><input type="hidden" name="hidden_expert_profile_image" value="<?php echo $row["expert_profile_image"]; ?>" />');
		...
		{		
			$.ajax({
				...
				success:function(data)
				{
                    ...
                    {
                        $('#uploaded_image').html('<img src="'+data.expert_profile_image+'" class="img-thumbnail" width="100" />');
