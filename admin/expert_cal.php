...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Expert Calculation</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold text-danger">Expert Publication & rating List</h6>
                            	</div>
