...
if(isset($_POST["submit"])){
			...
			$na= $_SESSION["user_name"];
			$da=date('Y-m-d');
			$t=date('d-m-y h:i:s');
			$pid=0;
			$object->query = "
			
		INSERT INTO post_table VALUES('','$tit','$txt','$da','$t','On Hold','$na','$uid','','','','','')";
...
"><br>
    ...
    border: solid 2px skyblue;
"><br><br>
				<input type="submit" name="submit" id="submit_button" class="btn btn-success" value="Post" />
