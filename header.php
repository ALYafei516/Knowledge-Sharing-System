...
<html lang="en">
	...
	<body>
		<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-danger border-bottom box-shadow">
			<div class="col">
		    	<h5 class="my-0 mr-md-auto font-weight-normal"><a href="#" class="text-white" style="text-decoration: none;">FK-EduSearch</a></h5>
		    </div>
		    <?php
	    ...
	    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
	      	<h1 class="display-4">Knowledge Sharing System</h1>
	    </div>
	    <br />
	    <br />
