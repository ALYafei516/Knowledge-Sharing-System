...
<div class="container-fluid">
	...
	<br />
	<div class="card">
		<div class="card-header"><h4>Bug Report</h4></div>
			<div class="card-body">
    ...
    padding: 4px;
				...
				<label><b>Bug Report Description</b></label><br>
				<input type="text" name="description" placeholder=" write description of bug in detail" required style="
    height: 200px;
    width: 100%;
