...
if(isset($_POST["action"]))
{
	...
	if($_POST["action"] == 'Add')
	{
		...
		else
		{
			...
			{
				$allowed_file_format = array("docx", "pdf");
			    ...
			    {
			        $error = "<div class='alert alert-danger'>Upload valiid file. docx, pdf</div>";
			    }
	...
	if($_POST["action"] == 'Edit')
	{
		...
		else
		{
			...
			if($_FILES['expert_profile_image']['name'] != '')
			{
	    		...
	    		if(!in_array($file_extension, $allowed_file_format))
			    {
			        $error = "<div class='alert alert-danger'>Upload valiid file. docs, pdf</div>";
			    }
			    else if (($_FILES["expert_profile_image"]["size"] > 2000000))
			    {
			       $error = "<div class='alert alert-danger'>File size exceeds 2MB</div>";
